...
class Step03DatePicker:
    ...
    def run(self) -> dict:
        ...
        self.browser.take_screenshot('step03_01_picker_opened')
        ...
        self.browser.take_screenshot('step03_02_months_navigated')
        ...
        self.browser.take_screenshot('step03_03_checkin_selected')

        # ── 4. Select a valid Check-out date (after check-in) ─────────────────
        co_ok = self._pick_day(is_checkin=False)
        self.browser.wait(1500)
        self.browser.take_screenshot('step03_04_checkout_selected')
