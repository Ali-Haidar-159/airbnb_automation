...
class Step01LandingAndSearch:
    ...
    def run(self) -> str:
        ...
        self.browser.take_screenshot('step01_01_homepage_loaded')

        # ── 2. Clear storage WITHOUT reload (this fixes the refresh bug) ──────
        self.browser.clear_storage_no_reload()
        ...
        self.browser.wait(1000)
        self.browser.take_screenshot('step01_02_popups_dismissed')
        ...
        self.browser.take_screenshot('step01_03_search_field_active')
        ...
        self.browser.take_screenshot('step01_04_country_typed')
