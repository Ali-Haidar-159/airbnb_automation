...
class BrowserService:
    ...
    def clear_storage_no_reload(self):
        """
        Clear cookies + localStorage + sessionStorage WITHOUT any page reload.
        ...
        try:
            ...
            pass
        logger.info("Storage cleared (no reload)")
    ...
    def take_screenshot(self, name: str) -> str:
        ...
        path = os.path.join(self.screenshot_dir, f"{name}_{ts}.png")
        try:
